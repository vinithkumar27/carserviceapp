<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    import="com.carserviceapp.model.*"  import="com.carserviceapp.dao.*"%>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<%!ResultSet rs; %>
<%
int center_id=Integer.parseInt(session.getAttribute("centerid").toString());
CarPickUp admincenter = new CarPickUp(center_id);
CarPickUpDAOImpl cpdao = new CarPickUpDAOImpl();
rs = cpdao.admincenterview(admincenter);
%>
